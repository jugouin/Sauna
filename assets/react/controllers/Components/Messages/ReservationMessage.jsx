export const ReservationMessage = (formData) => {
    ...
    return {
        ...
        Le prix de la réservation est de ${privatized ? `${saunaType === 'petit' ? '40' : '120'}` : `prix qui ne fonctionne pas` } CHF, vous pouvez régler directement sur place en espèce ou par TWINT.
